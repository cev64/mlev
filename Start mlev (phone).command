#!/bin/bash
# Double-click this file to start mlev so your PHONE can reach it too.
#
# Same as "Start mlev.command", except it also listens on your local network
# and prints the address (and a QR code) for the Android app.
#
# While this is running, anyone on your Wi-Fi can open it. Use the plain
# "Start mlev.command" if you only want it on this computer.
#
...
banner "mlev — starting with phone access"
...
exec python -m app.launch --port "$PORT" --lan
